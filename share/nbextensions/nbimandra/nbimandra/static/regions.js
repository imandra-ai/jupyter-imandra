define(['nbextensions/nbimandra/carrotsearch.foamtree', 'nbextensions/nbimandra/d3.v4.min', 'nbextensions/nbimandra/styles'], function (_, d3, styles) {
    ...
    return {
        draw: function (id, data) {
            var foamtree = new window.CarrotSearchFoamTree({
                id: id,
                dataObject: {
                    groups: ConstructGroups(data.regions)
                }
            });
            foamtree.set(styles);
        }
